          ...
          <section class="col-lg-7">
            ...
            <div class="card card-light">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><span style="color: #28a745;" class="fas fa-search mr-3"></span>História clínica</h3>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name="servicio" id="servicio" class="form-control " required  onChange="update()">
                  ...
                  <option style="color:#7FA8D6;" value="#7FA8D6">auriculoterapia</option>
